...
To get started with Tags, check out the [Tagged PRs]({{< ref "docs/pull-requests/dashboards/tagged-prs/" >}}) documentation.
...
To get started with Filters, check out the [Filter PRs]({{< ref "docs/pull-requests/filter-prs/" >}}) documentation.
...
To get started with the new accessibility settings, check out the [Settings]({{< ref "docs/settings/" >}}) documentation.
